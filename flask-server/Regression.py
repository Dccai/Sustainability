...
predictor=[0.4,400,300,200,7,4,0.1,5]
...
print(Heating.predict(newX))
print(Cooling.predict(newX))
print(Cooling.score(cooling_test_x,cooling_test_y))
print(Heating.score(heating_test_x,heating_test_y))
#print(Heating.w)
#print(Heating.b)
#print(Cooling.w)
#print(Cooling.b)
#Testing The Linear Regression With Training Data and getting the w and b values to use in the React app